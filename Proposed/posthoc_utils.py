...
class DSFTrainer(ModelTrainer):
    ...
    def train_single_epoch(self):
        ...
        for b, batch in enumerate(self.train_loader):
            ...
            "batch_loss: {:.2f}, qloss: {:.2f}, ploss: {:.2f}, divloss: {:.3f}, ".format(batch_loss.item(), batch_qloss.item(), batch_ploss.item(), batch_divloss.item()) +
...
class ModelDSFTest(ModelTest):
    def __init__(self, model, data_loader, args, device, ploss_criterion=None):
        ...
        if self.model_type in ["R2P2_SimpleRNN", "R2P2_RNN", "CAM_NFDecoder", "Scene_CAM_NFDecoder", "Global_Scene_CAM_DSF_NFDecoder", "AttGlobal_Scene_CAM_NFDecoder"]:
